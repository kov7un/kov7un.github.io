    ...
    var u = {
                ...
                var e = m(this),
                    ...
                    t = void 0 !== f["wpforms_" + t] && f["wpforms_" + t].hasOwnProperty("validate") ? f["wpforms_" + t].validate : "undefined" != typeof wpforms_validate ? wpforms_validate : {
                        ...
                        onclick: function(e) {
                            var t = !1,
                                r = (e || {}).type,
                                a = m(e); - 1 < ["checkbox", "radio"].indexOf(r) && ((a = a.hasClass("wpforms-likert-scale-option") ? a.closest("tr") : a.closest(".wpforms-field")).find("label.wpforms-error").remove(), t = !0), t && this.element(e)
                        }
                    };
                e.validate(t)
            }))
        ...
        loadDatePicker: function() {
            void 0 !== m.fn.flatpickr && m(".wpforms-datepicker-wrap").each(function() {
                var a = m(this),
                    ...
                    r = void 0 !== f["wpforms_" + t + "_" + r] && f["wpforms_" + t + "_" + r].hasOwnProperty("datepicker") ? f["wpforms_" + t + "_" + r].datepicker : void 0 !== f["wpforms_" + t] && f["wpforms_" + t].hasOwnProperty("datepicker") ? f["wpforms_" + t].datepicker : "undefined" != typeof wpforms_datepicker ? wpforms_datepicker : {
                        disableMobile: !0
                    },
        ...
        loadChoicesJS: function() {
            "function" == typeof f.Choices && m(".wpforms-field-select-style-modern .choicesjs-select, .wpforms-field-payment-select .choicesjs-select").each(function(e, t) {
                var r, a;
                m(t).data("choicesjs") || (r = f.wpforms_choicesjs_config || {}, a = m(t).data("search-enabled"), r.searchEnabled = void 0 === a || a, r.callbackOnInit = function() {
                    var t = this,
                        r = m(t.passedElement.element),
                        a = m(t.input.element),
                        e = r.data("size-class");
        ...
        optinMonsterRecaptchaReset: function(e) {
            var t, r, e = m("#om-" + e).find(".wpforms-form"),
        ...
        amountTotal: function(e, r) {
            r = r || !1;
            var a = m(e).closest(".wpforms-form"),
                e = u.getCurrency(),
                t = u.amountTotalCalc(a),
                t = u.amountFormat(t),
        ...
        currentIpToCountry: function(r) {
            function t() {
                m.get("https://ipapi.co/jsonp", function() {}, "jsonp").always(function(e) {
        ...
        displayFormAjaxErrors: function(e, t) {
            "string" == typeof t ? u.displayFormAjaxGeneralErrors(e, t) : (t = t && "errors" in t ? t.errors : null, u.empty(t) || u.empty(t.general) && u.empty(t.field) ? u.consoleLogAjaxError() : (u.empty(t.general) || u.displayFormAjaxGeneralErrors(e, t.general), u.empty(t.field) || u.displayFormAjaxFieldErrors(e, t.field)))
        },
        displayFormAjaxGeneralErrors: function(r, e) {
            r && r.length && (u.empty(e) || ("string" == typeof e ? r.find(".wpforms-submit-container").before('<div class="wpforms-error-container">' + e + "</div>") : m.each(e, function(e, t) {
                switch (e) {
                    case "header":
                        r.prepend(t);
                        break;
        ...
        formSubmitAjax: function(o) {
            ...
            var t, e, i = o.closest(".wpforms-container"),
                s = o.find(".wpforms-submit-spinner");
            return i.css("opacity", .6), s.show(), u.clearFormAjaxGeneralErrors(o), (e = new FormData(o.get(0))).append("action", "wpforms_submit"), e.append("page_url", f.location.href), e = {
                ...
                success: function(e) {
                    if (e)
                        if (e.data && e.data.action_required) o.trigger("wpformsAjaxSubmitActionRequired", e);
                        else {
                            if (e.success) return o.trigger("wpformsAjaxSubmitSuccess", e), e.data ? e.data.redirect_url ? (o.trigger("wpformsAjaxSubmitBeforeRedirect", e), void(f.location = e.data.redirect_url)) : void(e.data.confirmation && (i.html(e.data.confirmation), t = i.find("div.wpforms-confirmation-scroll"), i.trigger("wpformsAjaxSubmitSuccessConfirmation", e), t.length && u.animateScrollTop(t.offset().top - 100))) : void 0;
                            u.resetFormRecaptcha(o), u.displayFormAjaxErrors(o, e.data), void o.trigger("wpformsAjaxSubmitFailed", e)
                        }
        ...
        animateScrollTop: function(e, t, r) {
            return t = t || 1e3, r = "function" == typeof r ? r : function() {}, m("html, body").animate({
